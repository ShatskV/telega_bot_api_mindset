...
def upgrade():
    ...
    op.create_index(op.f('ix_bot_RatingQuery_message_id'), 'RatingQuery', ['message_id'], unique=False, schema='bot')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_bot_RatingQuery_message_id'), table_name='RatingQuery', schema='bot')
    op.drop_table('RatingQuery', schema='bot')
